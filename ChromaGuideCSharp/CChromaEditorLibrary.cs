...
namespace ChromaSDK
{
    public class CChromaEditorLibrary
    {
        ...
        /// <summary>
        /// Set this flag to use custom key colors
        /// </summary>
        public const int FLAG_CHROMA_CUSTOM_KEY = 0x01000000;

        /// <summary>
        /// Toggle using custom keyboard params
        /// </summary>
        /// <param name="path"></param>
        /// <param name="loop"></param>
        [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern void PluginKeyboardUseChromaCustom(int animationId, bool flag);
        ...
        public static int CreateAnimationInMemory(Device device)
        {
            Init();
            int dt = 0;
            int d = 0;
            ...
            try
            {
                result = PluginCreateAnimationInMemory(dt, d);
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("Failed to create animation in memory: exception={0}", ex));
            }
            return result;
        }
